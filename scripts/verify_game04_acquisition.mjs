...
assert.equal(isValidSupabaseUrl("https://lrgyllgzcdcphlbmkknc.supabase.co", "preview"), true);
assert.equal(isValidSupabaseUrl("https://ktpolnkyyfkowxdmijww.supabase.co", "preview"), false);
assert.equal(isValidSupabaseUrl("https://lrgyllgzcdcphlbmkknc.supabase.co", "production"), false);
