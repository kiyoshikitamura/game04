...
const OUT='docs/verification/stage68-resolution-20260927',folder=process.argv[2]??'pressure-aoe',extended=process.argv.includes('--extend'),ids=process.argv.slice(3).filter(x=>!x.startsWith('--')),sig=c=>hash(c.input.party);
