...
追補：ユーザー指摘を受け、GAME04固有の活動ルール追加を再精査した。[ACTIVITY_RULE_PROPOSAL.md](./ACTIVITY_RULE_PROPOSAL.md) を参照。下記のSSR交換に関する暫定推奨・未決範囲は追補で更新する。攻略・育成成果の掲載追加は採用判断待ちであり、活動ルール全体が完成したとは扱わない。
