...
## M2.1 — Dependency Security Patch

Outcome: the accepted engineering foundation runs on a supported dependency
baseline without known high or critical production findings.
