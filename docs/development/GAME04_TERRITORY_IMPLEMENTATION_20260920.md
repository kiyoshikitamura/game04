...
| 既存回帰 | 個別勝敗/3勝報酬/非遡及/Lv強化/旧Lv精算/中央スクロール | 実API通常開始WIN/行動力5/旧Lv精算/敵HP6500→7475 PASS。専用Lv14 LOSE/勝利数不増PASS。スマホPreview確認中 |
...
- Edge `game04-redesign-api` version 4 ACTIVE / verify_jwt=true。
- Preview: `a74304373f6ee026b50234a879102f1f99b4306e` Vercel success。branch URL `/qa/redesign` 領土CTA等表示確認。TI-01〜04は接続scopeのPreview反映済、TI-05はスマホ幅最終確認待ちで着手中。
- スマホ幅QA追加commit `d1434e3d22c6b9a194f29ae408d559331170be0b` はbuild中。
