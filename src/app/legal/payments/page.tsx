...
export default async function Page({ searchParams }: PageProps) {
  ...
  return (
    <LegalPage title="有償通貨・購入品について" updatedAt="2026年9月18日" returnToGame={from === "settings"}>
      ...
      <h2>有効期限</h2>
      <p>有償ダイヤおよび有料パックで購入した未使用のCASH・アイテム・チケットは、最初のゲーム内付与から120日で失効します。プレゼント受取による期限の延長はありません。無償分にはこの期限を適用しません。</p>
      <p>有効期限の近い購入分から消費します。有償ダイヤから交換したCASH・回復アイテムには元の期限を引き継ぎます。複数の期限を含む支払いは期限順に配分し、分割できない1個の交換品には先に使用した有償分の期限を適用します。</p>
