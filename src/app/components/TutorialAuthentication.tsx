  ...
  return (
    ...
    <div className="modal-overlay background-black-95" style={{ zIndex: 20001 }}>
      <div className="modal-card" style={{ maxWidth: 420 }} role="dialog" aria-modal="true" aria-labelledby="account-switch-title">
        ...
        {accountConflict.method === "GOOGLE" && process.env.NEXT_PUBLIC_GOOGLE_ACCOUNT_REPLACEMENT_ENABLED === "true" && process.env.NEXT_PUBLIC_APP_ENV === "preview" && process.env.NEXT_PUBLIC_SUPABASE_URL === "https://lrgyllgzcdcphlbmkknc.supabase.co" && Boolean(process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID) && <button className="semantic-cta semantic-cta--danger mt-2 width-100" onClick={() => void replaceWithCurrentData()} disabled={working}>
          現在のデータで置き換える
        </button>}
