...
export default function RaidView({state,rooms,party,onAction,onOpenDeck,initialRoomId,initialPreparationLevel}:RaidViewProps){
 ...
 function visual(value:RaidRoom){
  ...
  return {bossName:m.name,characterUrl:characterArt(e,'full'),backgroundUrl:raidBackground(m,value.level)??'/bg/raid/raid-castle-moonlight-v1.webp',ownerName:owner?.name??'開催者情報を取得できません',ownerImageUrl:owner?.portraitUrl,
