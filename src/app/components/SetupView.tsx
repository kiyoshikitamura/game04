...
export const WORLD_STAGES: readonly WorldStage[] = [
  {
    ...
    highlights: [],
    characters: [
      { name: "織田信長", src: "/characters/reiji_transparent_asset.png" },
      { name: "豊臣秀吉", src: "/characters/ageha_transparent_asset.png" },
      { name: "武田信玄", src: "/characters/go_transparent_asset.png" },
    ],
  },
  {
    ...
    highlights: [],
    characters: [
      { name: "徳川家康", src: "/characters/karen_transparent_asset.png" },
  ...
  return (
    <div className={`setup-container scroll-container custom-scrollbar ${presentationState === "NAME_INPUT" ? "is-registration" : "is-world-entry"}`} onClick={handleFirstUserInteraction} data-entry-state={presentationState}>
      ...
      {presentationState === "WORLD_INFORMATION" ? (
        ...
        <section className="setup-world-transition" aria-label="豊臣秀吉の案内へ移動中"><span aria-hidden="true" /></section>
      ) : presentationState === "AGEHA_INTRO" ? (
        <section className="setup-ageha-presentation" aria-label="豊臣秀吉の自己紹介">
          ...
          <div className="setup-ageha-dialogue"><div className="setup-ageha-name">豊臣秀吉</div><TypewriterText text={AGEHA_INTRO_COPY} speedMs={34} /></div>
        ...
        <section className="setup-name-scene" aria-label="名前入力">
          ...
          <div className="setup-box setup-name-dialog auth-box" role="dialog" aria-modal="true" aria-labelledby="setup-name-title">
            <div className="setup-name-guidance"><strong>豊臣秀吉</strong><span>キミの名前を教えて？</span></div>
