...
export default function TutorialRuleGuide() {
  ...
  if (phase === "AGEHA_END") {
    return <div className="tutorial-rule-screen tutorial-ageha-end-screen" role="dialog" aria-modal="true" aria-label="豊臣秀吉のチュートリアル終了案内" data-acceptance-state="AGEHA_END_MESSAGE">
      <section className="tutorial-ageha-end-frame">
        ...
        <div className="tutorial-ageha-end-dialogue"><strong>豊臣秀吉</strong><TypewriterText text={AGEHA_END_MESSAGE} speedMs={34} /></div>
