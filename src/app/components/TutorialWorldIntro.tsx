...
export default function TutorialWorldIntro() {
  ...
  return (
    <div className="tutorial-world" role="dialog" aria-modal="true" aria-label="豊臣秀吉からの案内">
      <div className="tutorial-world-content">
        ...
        <div className="tutorial-world-dialogue"><strong>豊臣秀吉</strong><TypewriterText text={`よろしく、${username || setupUsername}！\nこの街、一人でやってくのは結構大変なんだ。\nまずは仲間を集めよっか。`} speedMs={34} /></div>
        <button
