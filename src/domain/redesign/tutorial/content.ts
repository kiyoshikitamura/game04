...
export const SCENES = [
  { id: 'world-1', effectId: 'char_reiji_01', cast: ['char_reiji_01'], background: BACKGROUNDS.oda, text: '時は戦国。\n各地の武将が領地を争い、天下を狙う時代。\n織田信長もまた、その頂へと歩みを進めていた。' },
  { id: 'world-2', effectId: 'char_koharu_01', cast: ['char_koharu_01', 'char_go_01'], background: BACKGROUNDS.uesugi, text: '己の義を貫く者。力で乱世を切り拓く者。\n上杉謙信、武田信玄――\nそれぞれの信念が、戦場でぶつかり合う。' },
  { id: 'world-3', effectId: 'char_karen_01', cast: ['char_ageha_01', 'char_karen_01'], background: BACKGROUNDS.tokugawa, text: '才覚で駆け上がる豊臣秀吉。\n機を待ち、着実に力を蓄える徳川家康。\nそして今、あなたも天下を目指す旅に出る。' },
