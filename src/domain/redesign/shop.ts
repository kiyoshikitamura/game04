...
export const SHOP_EXCHANGE_OPTIONS = [
  ...
  { id: 'cash_3000', title: '銭 3,000', description: '育成や通常登用に使う銭', cost: 300, reward: '銭 ×3,000', maxQuantity: 1 },
  { id: 'cash_5000', title: '銭 5,000', description: '育成や通常登用に使う銭', cost: 500, reward: '銭 ×5,000', maxQuantity: 1 },
  { id: 'cash_10000', title: '銭 10,000', description: '育成や通常登用に使う銭', cost: 1000, reward: '銭 ×10,000', maxQuantity: 1 },
  { id: 'cash_30000', title: '銭 30,000', description: '育成や通常登用に使う銭', cost: 3000, reward: '銭 ×30,000', maxQuantity: 1 },
  { id: 'cash_50000', title: '銭 50,000', description: '育成や通常登用に使う銭', cost: 5000, reward: '銭 ×50,000', maxQuantity: 1 },
  { id: 'raid_unlock', title: '領土侵攻札', description: '領土侵攻を開催するための札', cost: 100, reward: '領土侵攻札 ×1', maxQuantity: 1 },
